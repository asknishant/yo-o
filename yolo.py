...
#out = cv.VideoWriter('video.avi',cv2.VideoWriter_fourcc(*'DIVX'), 5, (width,height))
FLAGS = []
...
if __name__ == '__main__':
	...
	parser.add_argument('-m', '--D:\Yolo\yolov3-coco',
		type=str,
		default='./yolov3-coco/',
		...
		try:
			...
			while True:
				...
				if writer is None:
					...
					writer = cv.VideoWriter(FLAGS.video_output_path, fourcc, 60, 
